...
extra_requirements = {"redis": ["aioredis>=1.0.0"], "postgresql": ["psycopg2"]}
...
class PublishCommand(Command):
    ...
    user_options = [("test", None, "publish to TestPyPI")]
...
setup(
    ...
    entry_points={"console_scripts": ["hero=hero.cli:main_cli",],},
    ...
    packages=find_namespace_packages(
        include=["hero", "hero.*", "hero.extensions.essentials"],
        exclude=["*.migrations"],
    ),
